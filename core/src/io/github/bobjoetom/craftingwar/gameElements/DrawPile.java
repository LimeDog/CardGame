...
import io.github.bobjoetom.craftingwar.cards.Earth;
import io.github.bobjoetom.craftingwar.cards.Fire;
import io.github.bobjoetom.craftingwar.cards.Smeltery;
import io.github.bobjoetom.craftingwar.cards.Water;
    ...
    public void refresh(){
            ...
            if(cards.size()<3) {
                ...
                if (r == 0) {
                    ...
                    cards.add(0, new Water());
                } else if (r == 2) {
                    cards.add(0, new Earth());
                }//else if (r == 3){
